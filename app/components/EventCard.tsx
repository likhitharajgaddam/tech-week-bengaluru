...
import { MapPin, Calendar, ExternalLink, Zap, Trophy, Users, Lightbulb } from "lucide-react";
      ...
      <div className="section-inner">
        ...
        >
          ...
          <p className="text-subtitle">
            Four landmark events spread across the week, each offering unique learning and networking experiences.
          </p>
        </motion.div>
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  /* Fixed height — button always at bottom via flex */
                  display: "flex",
              ...
              >
                ...
                {/* Card body — flex-grow to push button down */}
                <div className="relative flex flex-col flex-1" style={{ padding: "28px 28px 28px" }}>
                  ...
                  >
                    {event.link.startsWith("http") && <ExternalLink size={15} />}
                    Learn More
                  </a>
                </div>
              </motion.div>
